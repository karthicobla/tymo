            ...
            const app = {
                    ...
                    card.innerHTML = `
                        ...
                        <div class="relative flex gap-0.5 text-center ${completeClass} min-h-[3.5rem]" data-date="${timerDateString}" data-id="${dateData.id}" data-time-container 
                            ...
                            <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                ...
                                <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-days-label>Days</span>
                            </div>
                            <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                <span class="block text-sm font-bold text-primary" data-hours>00</span>
                                <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-hours-label>Hours</span>
                            </div>
                            <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                <span class="block text-sm font-bold text-primary" data-minutes>00</span>
                                <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-minutes-label>Mins</span>
                            </div>
                            <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                <span class="block text-sm font-bold text-primary" data-seconds>00</span>
                                <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-seconds-label>Secs</span>
                            </div>
                ...
                updateTimer(el) {
                    ...
                    const createYMDBox = (value, label, isAgo = false) => {
                       // NEW: Handle pluralization. Label is passed as plural ("Years", "Months", "Days")
                       const singularLabel = label.slice(0, -1); // "Year", "Month", "Day"
                       const correctLabel = value === 1 ? singularLabel : label;
                       ...
                       if (isAgo) {
                           ...
                           return `<div class="bg-interactive-deep py-1 px-1 rounded flex-col justify-center border border-color-strong opacity-90 flex-1 min-w-0">
                            ...
                            if (timeContainer) {
                                ...
                                timeContainer.innerHTML = `
                                    <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                        ...
                                        <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-hours-label>${hours === 1 ? 'Hour' : 'Hours'}</span>
                                    </div>
                                    <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                        <span class="block text-sm font-bold text-primary" data-minutes>${String(minutes).padStart(2, '0')}</span>
                                        <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-minutes-label>${minutes === 1 ? 'Min' : 'Mins'}</span>
                                    </div>
                                    <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
...
<!-- ... existing code ...
                            ...
                            // NEW: Update labels for pluralization
                            const hoursLabel = el.querySelector('[data-hours-label]');
                            if (hoursLabel) hoursLabel.textContent = hours === 1 ? 'Hour' : 'Hours';

                            const minutesLabel = el.querySelector('[data-minutes-label]');
                            if (minutesLabel) minutesLabel.textContent = minutes === 1 ? 'Min' : 'Mins';
                        }
                    } else {
                            ...
                            if (timeContainer) {
                                ...
                                timeContainer.innerHTML = `
                                    <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                        ...
                                        <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-days-label>${days === 1 ? 'Day' : 'Days'}</span>
                                    </div>
                                    <div class="bg-interactive py-1 px-1 rounded flex-1 flex flex-col justify-center" data-timer-segment>
                                        <span class="block text-sm font-bold text-primary" data-hours>${String(hours).padStart(2, '0')}</span>
                                        <span class="block text-[0.55rem] leading-none font-medium text-muted uppercase" data-hours-label>${hours === 1 ? 'Hour' : 'Hours'}</span>
...
<!-- ... existing code ...
                            ...
                            // NEW: Update labels for pluralization
                            const daysLabel = el.querySelector('[data-days-label]');
                            if (daysLabel) daysLabel.textContent = days === 1 ? 'Day' : 'Days';
                            ...
                            // Secs is always plural, that's fine.
                        }
                    }
